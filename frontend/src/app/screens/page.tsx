            ...
            return prev.map((d) => {
              if (d.device_identifier === detail.device_identifier || (detail.id && d.id === detail.id)) {
                return {
                  ...
                  app_version: detail.app_version || d.app_version,
                  device_model: detail.device_model || d.device_model,
                  connection_type: detail.connection_type || d.connection_type,
                  network_speed_mbps: detail.network_speed_mbps ?? d.network_speed_mbps,
                  mac_address: detail.mac_address || d.mac_address,
