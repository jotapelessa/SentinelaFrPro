---
source_file: "frontend/src/components/WebSocketProvider.tsx"
type: "code"
...
## Connections
- [[SecurityEvent]] - `imports` [EXTRACTED]
- [[WebSocketProvider()]] - `contains` [EXTRACTED]
- [[applayout.tsx]] - `imports_from` [EXTRACTED]
- [[playAlertChime()]] - `contains` [EXTRACTED]
