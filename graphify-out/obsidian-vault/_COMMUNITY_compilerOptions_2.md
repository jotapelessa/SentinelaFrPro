...
- 10 edges to [[_COMMUNITY_Histórias]]
- 8 edges to [[_COMMUNITY_TvNetflixScreen.kt]]
- 3 edges to [[_COMMUNITY_onp-spec-driven — a especificação que continua verdadeira (Antigravity)]]
...
- 1 edge to [[_COMMUNITY_PipSize]]

## Top bridge nodes
- [[CameraItem]] - degree 19, connects to 6 communities
- [[SentinelaConfig]] - degree 12, connects to 5 communities
- [[SeamlessCameraImage()]] - degree 20, connects to 4 communities
