...
## Corpus Check
- 158 files · ~147,161 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1342 nodes · 2072 edges · 94 communities (59 shown, 19 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `70ccf821`
...
3. `Camera` - 26 edges
4. `PairedDevice` - 25 edges
5. `SentinelaPreferences` - 22 edges
6. `OverlayService` - 20 edges
...
Cohesion: 0.05
Nodes (63): CameraItem, PipSize, CINEMA, EXTRA_LARGE, EXTRA_SMALL, LARGE, MEDIUM, MEDIUM_LARGE (+55 more)
...
### Community 19 - "SentinelaRepository.kt"
Cohesion: 0.25
Nodes (5): DevicePolicy, Context, RemoteDeviceItem, HttpURLConnection, URL
...
- **Why does `update_device_status()` connect `devices.py` to `SentinelaRepository`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `SentinelaPreferences` connect `TvNetflixScreen.kt` to `OverlayService`, `PipDuration`, `PipPosition`, `SentinelaRepository`?**
