...
## Corpus Check
- 167 files · ~193,905 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1487 nodes · 2360 edges · 104 communities (68 shown, 19 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 92 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `af73e013`
...
Cohesion: 0.17
Nodes (11): 📺 1. Android TV 55" (Layout Horizontal Estilo Netflix), 📱 2. Android Smartphone (Layout Vertical Estilo YouTube), 📱 Aplicativos Nativos Android (`v001.000.000.132`), 🖥️ Como Atualizar o Servidor Ubuntu, 🚀 Como Compilar os APKs no GitHub Codespaces, 📥 Download dos APKs Oficiais (`v001.000.000.132`), 📄 Licença, 🗺️ Mapa de Portas e Serviços (+3 more)
...
Cohesion: 0.19
Nodes (16): SentinelaPreferences, DeviceConfigEditDialog(), com, PhoneBottomNavigationBar(), PhoneCameraStreamCard(), PhoneCapturesTab(), PhoneLiveCamerasTab(), PhoneLogsTab() (+8 more)
...
### Community 102 - "CaptureEvent"
Cohesion: 1.00
Nodes (3): CaptureEvent, PhoneClipPlayerDialog(), PhonePhotoViewerDialog()
...
- **Why does `SentinelaPreferences` connect `SentinelaPreferences` to `PipPosition`, `PipSize`, `OverlayService`, `SentinelaRepository`, `PipDuration`, `CameraItem`, `.onCreate`, `ActivityLifecycleCallbacks`?**
